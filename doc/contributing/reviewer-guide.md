...
| #888 | `test/meos-smoke-ci` | Comprehensive MEOS smoke-test suite for all types (subsumes closed #885) | ✅ | |
...
| #934 | `meos/bootstrap-batch` | MEOS bootstrap batch — locale + UTF-8 + Windows (consolidates #813+#814+#812; setlocale→pgwin32_setlocale fix folded into Windows commit 2026-05-12) | ✅ |
