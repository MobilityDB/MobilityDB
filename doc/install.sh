...
dblatex -T native -t pdf -o $installpath/mobilitydb.pdf mobilitydb-manual.xml
...
dblatex -T native -t pdf -o $installpath/workshop/workshop.pdf mobilitydb-workshop.xml
