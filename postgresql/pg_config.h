...
#define CONFIGURE_ARGS " '--prefix=/usr/local/pgsql/13/' '--with-libxml' 'CFLAGS=-g -O0'"
...
#define PG_VERSION_STR "PostgreSQL 13.5 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 9.3.0-17ubuntu1~20.04) 9.3.0, 64-bit"
