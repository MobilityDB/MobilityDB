...
string(REGEX REPLACE "^([0-9]+)\\.([0-9]+).*" "\\1" POSTGRESQL_MAJOR_VERSION ${POSTGRESQL_VERSION})
string(REGEX REPLACE "^([0-9]+)\\.([0-9]+).*" "\\2" POSTGRESQL_MINOR_VERSION ${POSTGRESQL_VERSION})

message(STATUS "POSTGRESQL_MAJOR_VERSION=${POSTGRESQL_MAJOR_VERSION}")
message(STATUS "POSTGRESQL_MINOR_VERSION=${POSTGRESQL_MINOR_VERSION}")
math(EXPR POSTGRESQL_VERSION_NUMBER "${POSTGRESQL_MAJOR_VERSION} * 10000 + ${POSTGRESQL_MINOR_VERSION} * 100")
