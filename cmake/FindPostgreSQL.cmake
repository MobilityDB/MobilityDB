...
string(REGEX REPLACE "^([0-9]+)\\.([0-9]+).*" "\\1" POSTGRESQL_VERSION_MAYOR ${POSTGRESQL_VERSION})
string(REGEX REPLACE "^([0-9]+)\\.([0-9]+).*" "\\2" POSTGRESQL_VERSION_MINOR ${POSTGRESQL_VERSION})

message(STATUS "POSTGRESQL_VERSION_MAYOR=${POSTGRESQL_VERSION_MAYOR}")
message(STATUS "POSTGRESQL_VERSION_MINOR=${POSTGRESQL_VERSION_MINOR}")
math(EXPR POSTGRESQL_VERSION_NUMBER "${POSTGRESQL_VERSION_MAYOR} * 10000 + ${POSTGRESQL_VERSION_MINOR} * 100")

execute_process(
  COMMAND ${POSTGRESQL_PG_CONFIG} --includedir-server
  OUTPUT_STRIP_TRAILING_WHITESPACE
  OUTPUT_VARIABLE TEMP_POSTGRESQL_INCLUDE_DIR)
...
if (POSTGRESQL_FOUND)
  mark_as_advanced(POSTGRESQL_INCLUDE_DIR POSTGRESQL_LIBRARIES POSTGRESQL_BIN_DIR)
endif()
