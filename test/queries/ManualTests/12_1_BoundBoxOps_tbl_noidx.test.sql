...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tintinst', 'intrange', count(*) from tbl_tintinst, tbl_intrange where inst && i;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tintinst', 'float', count(*) from tbl_tintinst, tbl_float where inst && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tintinst', 'floatrange', count(*) from tbl_tintinst, tbl_floatrange where inst && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tintinst', 'box', count(*) from tbl_tintinst, tbl_box where inst && b;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatinst', 'intrange', count(*) from tbl_tfloatinst, tbl_intrange where inst && i;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatinst', 'float', count(*) from tbl_tfloatinst, tbl_float where inst && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatinst', 'floatrange', count(*) from tbl_tfloatinst, tbl_floatrange where inst && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatinst', 'box', count(*) from tbl_tfloatinst, tbl_box where inst && b;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatinst', 'tbl_tinti', count(*) from tbl_tfloatinst, tbl_tinti where inst && ti;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tinti', 'intrange', count(*) from tbl_tinti, tbl_intrange where ti && i;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tinti', 'float', count(*) from tbl_tinti, tbl_float where ti && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tinti', 'floatrange', count(*) from tbl_tinti, tbl_floatrange where ti && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tinti', 'box', count(*) from tbl_tinti, tbl_box where ti && b;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloati', 'intrange', count(*) from tbl_tfloati, tbl_intrange where ti && i;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloati', 'float', count(*) from tbl_tfloati, tbl_float where ti && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloati', 'floatrange', count(*) from tbl_tfloati, tbl_floatrange where ti && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloati', 'box', count(*) from tbl_tfloati, tbl_box where ti && b;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'ttexti', 'ttextinst', count(*) from tbl_ttexti, tbl_ttextinst where ti && inst;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tintseq', 'intrange', count(*) from tbl_tintseq, tbl_intrange where seq && i;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tintseq', 'float', count(*) from tbl_tintseq, tbl_float where seq && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tintseq', 'floatrange', count(*) from tbl_tintseq, tbl_floatrange where seq && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tintseq', 'box', count(*) from tbl_tintseq, tbl_box where seq && b;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatseq', 'intrange', count(*) from tbl_tfloatseq, tbl_intrange where seq && i;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatseq', 'float', count(*) from tbl_tfloatseq, tbl_float where seq && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatseq', 'floatrange', count(*) from tbl_tfloatseq, tbl_floatrange where seq && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloatseq', 'box', count(*) from tbl_tfloatseq, tbl_box where seq && b;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tints', 'intrange', count(*) from tbl_tints, tbl_intrange where ts && i;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tints', 'float', count(*) from tbl_tints, tbl_float where ts && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tints', 'floatrange', count(*) from tbl_tints, tbl_floatrange where ts && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tints', 'box', count(*) from tbl_tints, tbl_box where ts && b;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloats', 'intrange', count(*) from tbl_tfloats, tbl_intrange where ts && i;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloats', 'float', count(*) from tbl_tfloats, tbl_float where ts && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloats', 'floatrange', count(*) from tbl_tfloats, tbl_floatrange where ts && f;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
...
insert into test_boundboxops(op, leftarg, rightarg, noidx)
select '&&', 'tfloats', 'box', count(*) from tbl_tfloats, tbl_box where ts && b;
insert into test_boundboxops(op, leftarg, rightarg, noidx)
