...
/* tboolinst */
--before
select * from tbl_tboolinst where inst <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tboolinst where inst &<# timestamptz '2001-07-01';
select * from tbl_tboolinst where inst &<# period '[2001-03-01, 2001-06-01]';
...
--overafter
select * from tbl_tboolinst where inst #&> timestamptz '2001-03-01';
select * from tbl_tboolinst where inst #&> period '[2001-03-01, 2001-06-01]';
...
/* tboolper */
--before
select * from tbl_tboolper where per <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tboolper where per &<# timestamptz '2001-07-01';
select * from tbl_tboolper where per &<# period '[2001-03-01, 2001-06-01]';
...
--overafter
select * from tbl_tboolper where per #&> timestamptz '2001-03-01';
select * from tbl_tboolper where per #&> period '[2001-03-01, 2001-06-01]';
...
/* tboolp */
--before
select * from tbl_tboolp where tp <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tboolp where tp &<# timestamptz '2001-07-01';
select * from tbl_tboolp where tp &<# period '[2001-03-01, 2001-06-01]';
...
--overafter
select * from tbl_tboolp where tp #&> timestamptz '2001-03-01';
select * from tbl_tboolp where tp #&> period '[2001-03-01, 2001-06-01]';
...
/* tbooli */
--before
select * from tbl_tbooli where ti <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tbooli where ti &<# timestamptz '2001-07-01';
select * from tbl_tbooli where ti &<# period '[2001-03-01, 2001-06-01]';
...
--overafter
select * from tbl_tbooli where ti #&> timestamptz '2001-03-01';
select * from tbl_tbooli where ti #&> period '[2001-03-01, 2001-06-01]';
...
--before
select * from tbl_tintinst where inst <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tintinst where inst &<# timestamptz '2001-07-01';
select * from tbl_tintinst where inst &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_tintinst where inst &<# box '(60,47260800000000),(40,41990400000000)';
...
--overafter
select * from tbl_tintinst where inst #&> timestamptz '2001-03-01';
select * from tbl_tintinst where inst #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_tintinst where inst #&> box '(60,47260800000000),(40,41990400000000)';
...
--before
select * from tbl_tintper where per <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tintper where per &<# timestamptz '2001-07-01';
select * from tbl_tintper where per &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_tintper where per &<# box '(60,47260800000000),(40,41990400000000)';
...
--overafter
select * from tbl_tintper where per #&> timestamptz '2001-03-01';
select * from tbl_tintper where per #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_tintper where per #&> box '(60,47260800000000),(40,41990400000000)';
...
--before
select * from tbl_tintp where tp <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tintp where tp &<# timestamptz '2001-07-01';
select * from tbl_tintp where tp &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_tintp where tp &<# box '(60,47260800000000),(40,41990400000000)';
...
--overafter
select * from tbl_tintp where tp #&> timestamptz '2001-03-01';
select * from tbl_tintp where tp #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_tintp where tp #&> box '(60,47260800000000),(40,41990400000000)';
...
--before
select * from tbl_tinti where ti <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tinti where ti &<# timestamptz '2001-07-01';
select * from tbl_tinti where ti &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_tinti where ti &<# box '(60,47260800000000),(40,41990400000000)';
...
--overafter
select * from tbl_tinti where ti #&> timestamptz '2001-03-01';
select * from tbl_tinti where ti #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_tinti where ti #&> box '(60,47260800000000),(40,41990400000000)';
...
--before
select * from tbl_tfloatinst where inst <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tfloatinst where inst &<# timestamptz '2001-07-01';
select * from tbl_tfloatinst where inst &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_tfloatinst where inst &<# box '(60,47260800000000),(40,41990400000000)';
...
--overafter
select * from tbl_tfloatinst where inst #&> timestamptz '2001-03-01';
select * from tbl_tfloatinst where inst #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_tfloatinst where inst #&> box '(60,47260800000000),(40,41990400000000)';
...
--before
select * from tbl_tfloatper where per <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tfloatper where per &<# timestamptz '2001-07-01';
select * from tbl_tfloatper where per &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_tfloatper where per &<# box '(60,47260800000000),(40,41990400000000)';
...
--overafter
select * from tbl_tfloatper where per #&> timestamptz '2001-03-01';
select * from tbl_tfloatper where per #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_tfloatper where per #&> box '(60,47260800000000),(40,41990400000000)';
...
--before
select * from tbl_tfloatp where tp <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tfloatp where tp &<# timestamptz '2001-07-01';
select * from tbl_tfloatp where tp &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_tfloatp where tp &<# box '(60,47260800000000),(40,41990400000000)';
...
--overafter
select * from tbl_tfloatp where tp #&> timestamptz '2001-03-01';
select * from tbl_tfloatp where tp #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_tfloatp where tp #&> box '(60,47260800000000),(40,41990400000000)';
...
--before
select * from tbl_tfloati where ti <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_tfloati where ti &<# timestamptz '2001-07-01';
select * from tbl_tfloati where ti &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_tfloati where ti &<# box '(60,47260800000000),(40,41990400000000)';
...
--overafter
select * from tbl_tfloati where ti #&> timestamptz '2001-03-01';
select * from tbl_tfloati where ti #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_tfloati where ti #&> box '(60,47260800000000),(40,41990400000000)';
...
/* ttextinst */
--before
select * from tbl_ttextinst where inst <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_ttextinst where inst &<# timestamptz '2001-07-01';
select * from tbl_ttextinst where inst &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_ttextinst where inst &<# ttextinst 'AAA@2001-05-01';
select * from tbl_ttextinst where inst &<# ttextper 'AAA@[2001-05-01, 2001-07-01)';
select * from tbl_ttextinst where inst &<# ttextp '{AAA@[2001-05-01, 2001-07-01), BBB@[2001-07-01, 2001-09-01)}';
...
--overafter
select * from tbl_ttextinst where inst #&> timestamptz '2001-03-01';
select * from tbl_ttextinst where inst #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_ttextinst where inst #&> ttextinst 'AAA@2001-05-01';
select * from tbl_ttextinst where inst #&> ttextper 'AAA@[2001-05-01, 2001-07-01)';
select * from tbl_ttextinst where inst #&> ttextp '{AAA@[2001-05-01, 2001-07-01), BBB@[2001-07-01, 2001-09-01)}';
...
/* ttextper */
--before
select * from tbl_ttextper where per <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_ttextper where per &<# timestamptz '2001-07-01';
select * from tbl_ttextper where per &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_ttextper where per &<# ttextinst 'AAA@2001-05-01';
select * from tbl_ttextper where per &<# ttextper 'AAA@[2001-05-01, 2001-07-01)';
select * from tbl_ttextper where per &<# ttextp '{AAA@[2001-05-01, 2001-07-01), BBB@[2001-07-01, 2001-09-01)}';
...
--overafter
select * from tbl_ttextper where per #&> timestamptz '2001-03-01';
select * from tbl_ttextper where per #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_ttextper where per #&> ttextinst 'AAA@2001-05-01';
select * from tbl_ttextper where per #&> ttextper 'AAA@[2001-05-01, 2001-07-01)';
select * from tbl_ttextper where per #&> ttextp '{AAA@[2001-05-01, 2001-07-01), BBB@[2001-07-01, 2001-09-01)}';
...
/* ttextp */
--before
select * from tbl_ttextp where tp <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_ttextp where tp &<# timestamptz '2001-07-01';
select * from tbl_ttextp where tp &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_ttextp where tp &<# ttextinst 'AAA@2001-05-01';
select * from tbl_ttextp where tp &<# ttextper 'AAA@[2001-05-01, 2001-07-01)';
select * from tbl_ttextp where tp &<# ttextp '{AAA@[2001-05-01, 2001-07-01), BBB@[2001-07-01, 2001-09-01)}';
...
--overafter
select * from tbl_ttextp where tp #&> timestamptz '2001-03-01';
select * from tbl_ttextp where tp #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_ttextp where tp #&> ttextinst 'AAA@2001-05-01';
select * from tbl_ttextp where tp #&> ttextper 'AAA@[2001-05-01, 2001-07-01)';
select * from tbl_ttextp where tp #&> ttextp '{AAA@[2001-05-01, 2001-07-01), BBB@[2001-07-01, 2001-09-01)}';
...
/* ttexti */
--before
select * from tbl_ttexti where ti <<# timestamptz '2001-05-01';
...
--overbefore
select * from tbl_ttexti where ti &<# timestamptz '2001-07-01';
select * from tbl_ttexti where ti &<# period '[2001-03-01, 2001-06-01]';
select * from tbl_ttexti where ti &<# ttextinst 'AAA@2001-05-01';
select * from tbl_ttexti where ti &<# ttextper 'AAA@[2001-05-01, 2001-07-01)';
select * from tbl_ttexti where ti &<# ttextp '{AAA@[2001-05-01, 2001-07-01), BBB@[2001-07-01, 2001-09-01)}';
...
--overafter
select * from tbl_ttexti where ti #&> timestamptz '2001-03-01';
select * from tbl_ttexti where ti #&> period '[2001-03-01, 2001-06-01]';
select * from tbl_ttexti where ti #&> ttextinst 'AAA@2001-05-01';
select * from tbl_ttexti where ti #&> ttextper 'AAA@[2001-05-01, 2001-07-01)';
select * from tbl_ttexti where ti #&> ttextp '{AAA@[2001-05-01, 2001-07-01), BBB@[2001-07-01, 2001-09-01)}';
