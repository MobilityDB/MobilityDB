...
set gistidx = ( select count(*) from tbl_int, tbl_tintinst where i << inst )
where op = '<<' and leftarg = 'int' and rightarg = 'tintinst';
update test_relativeposops
set gistidx = ( select count(*) from tbl_int, tbl_tfloatinst where i << inst )
where op = '<<' and leftarg = 'int' and rightarg = 'tfloatinst';

update test_relativeposops
set gistidx = ( select count(*) from tbl_int, tbl_tinti where i << ti )
where op = '<<' and leftarg = 'int' and rightarg = 'tinti';
update test_relativeposops
set gistidx = ( select count(*) from tbl_int, tbl_tfloati where i << ti )
where op = '<<' and leftarg = 'int' and rightarg = 'tfloati';

update test_relativeposops
set gistidx = ( select count(*) from tbl_int, tbl_tintseq where i << seq )
where op = '<<' and leftarg = 'int' and rightarg = 'tintseq';
update test_relativeposops
set gistidx = ( select count(*) from tbl_int, tbl_tfloatseq where i << seq )
where op = '<<' and leftarg = 'int' and rightarg = 'tfloatseq';

update test_relativeposops
set gistidx = ( select count(*) from tbl_int, tbl_tints where i << ts )
where op = '<<' and leftarg = 'int' and rightarg = 'tints';
update test_relativeposops
set gistidx = ( select count(*) from tbl_int, tbl_tfloats where i << ts )
where op = '<<' and leftarg = 'int' and rightarg = 'tfloats';

-------------------------------------------------------------------------------

update test_relativeposops
set gistidx = ( select count(*) from tbl_float, tbl_tintinst where f << inst )
where op = '<<' and leftarg = 'float' and rightarg = 'tintinst';
update test_relativeposops
set gistidx = ( select count(*) from tbl_float, tbl_tfloatinst where f << inst )
where op = '<<' and leftarg = 'float' and rightarg = 'tfloatinst';

update test_relativeposops
set gistidx = ( select count(*) from tbl_float, tbl_tinti where f << ti )
where op = '<<' and leftarg = 'float' and rightarg = 'tinti';
update test_relativeposops
set gistidx = ( select count(*) from tbl_float, tbl_tfloati where f << ti )
where op = '<<' and leftarg = 'float' and rightarg = 'tfloati';

update test_relativeposops
set gistidx = ( select count(*) from tbl_float, tbl_tintseq where f << seq )
where op = '<<' and leftarg = 'float' and rightarg = 'tintseq';
update test_relativeposops
set gistidx = ( select count(*) from tbl_float, tbl_tfloatseq where f << seq )
where op = '<<' and leftarg = 'float' and rightarg = 'tfloatseq';

update test_relativeposops
set gistidx = ( select count(*) from tbl_float, tbl_tints where f << ts )
where op = '<<' and leftarg = 'float' and rightarg = 'tints';
update test_relativeposops
set gistidx = ( select count(*) from tbl_float, tbl_tfloats where f << ts )
