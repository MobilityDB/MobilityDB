...
extern void compute_twodim_traj_stats(VacAttrStats *stats, AnalyzeAttrFetchFunc fetchfunc,
									  int samplerows, double totalrows);
extern void compute_threedim_traj_stats(VacAttrStats *stats, AnalyzeAttrFetchFunc fetchfunc,
										int samplerows, double totalrows);
/*****************************************************************************
...
extern void gbox_deserialize(GBOX *box, int ndims, RangeBound *lowerdim1, RangeBound *upperdim1,
