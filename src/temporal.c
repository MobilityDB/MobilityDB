...
/**
 * @brief Returns true if the temporal value is ever different to a value
 */
PGDLLEXPORT Datum
...
/**
 * @brief Returns true if the temporal value is always different to a value
 */
PGDLLEXPORT Datum
...
/**
 * @brief Returns true if the temporal value is ever greater than the value
 */
PGDLLEXPORT Datum
...
/**
 * @brief Returns true if the temporal value is always greater than the value
 */
PGDLLEXPORT Datum
...
/**
 * @brief Returns true if the temporal value is ever greater than 
...
/**
 * @brief Returns true if the temporal value is always greater than 
 *		or equal to the value
 */
PGDLLEXPORT Datum
...
/**
 * @brief Restricts the temporal value to the complement of the maximum value
 */ 
PGDLLEXPORT Datum
