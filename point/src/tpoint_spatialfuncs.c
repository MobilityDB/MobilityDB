...
{
	return CallerFInfoFunctionCall2(geography_distance, _FCINFO->flinfo, InvalidOid,
		geog1, geog2);
...
{
	return CallerFInfoFunctionCall2(geography_azimuth, _FCINFO->flinfo, InvalidOid,
		geom1, geom2);
