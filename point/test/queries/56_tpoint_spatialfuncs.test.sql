...
SELECT setprecision(transform(stbox 'SRID=4326;GEODSTBOX((1,1,1),(2,2,2))', 4269), 8);
SELECT setprecision(transform(stbox 'SRID=4326;GEODSTBOX T((1,1,1,2000-01-01),(2,2,2,2000-01-02))', 4269), 8);
