...
insert into test_georelativeposops(op, leftarg, rightarg, noidx)
select '<<', 'tgeompointinst', 'tgeompointinst', count(*) from tbl_tgeompointinst t1, tbl_tgeompointinst t2 where t1.inst << t2.inst;
insert into test_georelativeposops(op, leftarg, rightarg, noidx)
select '>>', 'tgeompointinst', 'tgeompointinst', count(*) from tbl_tgeompointinst t1, tbl_tgeompointinst t2 where t1.inst >> t2.inst;
insert into test_georelativeposops(op, leftarg, rightarg, noidx)
select '&<', 'tgeompointinst', 'tgeompointinst', count(*) from tbl_tgeompointinst t1, tbl_tgeompointinst t2 where t1.inst &< t2.inst;
...
insert into test_georelativeposops(op, leftarg, rightarg, noidx)
select '<<', 'tgeompointseq', 'tgeompointseq', count(*) from tbl_tgeompointseq t1, tbl_tgeompointseq t2 where t1.seq << t2.seq;
insert into test_georelativeposops(op, leftarg, rightarg, noidx)
select '>>', 'tgeompointseq', 'tgeompointseq', count(*) from tbl_tgeompointseq t1, tbl_tgeompointseq t2 where t1.seq >> t2.seq;
insert into test_georelativeposops(op, leftarg, rightarg, noidx)
select '&<', 'tgeompointseq', 'tgeompointseq', count(*) from tbl_tgeompointseq t1, tbl_tgeompointseq t2 where t1.seq &< t2.seq;
