...
SELECT azimuth(seq) FROM tbl_tgeompointseq LIMIT 10;
SELECT azimuth(ts) FROM tbl_tgeompoints LIMIT 10;
SELECT azimuth(seq) FROM tbl_tgeogpointseq LIMIT 10;
SELECT azimuth(ts) FROM tbl_tgeogpoints LIMIT 10;

SELECT azimuth(seq) FROM tbl_tgeompoint3Dseq LIMIT 10;
SELECT azimuth(ts) FROM tbl_tgeompoint3Ds LIMIT 10;
SELECT azimuth(seq) FROM tbl_tgeogpoint3Dseq LIMIT 10;
SELECT azimuth(ts) FROM tbl_tgeogpoint3Ds LIMIT 10;
