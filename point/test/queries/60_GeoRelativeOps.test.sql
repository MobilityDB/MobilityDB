...
SELECT gbox 'GBOX M((-inf,-inf,-3.6e+09),(inf,inf,8.28e+10))' << gbox 'GBOX M((-inf,-inf,-3.6e+09),(inf,inf,8.28e+10))';
SELECT gbox 'GBOX M((-inf,-inf,-3.6e+09),(inf,inf,8.28e+10))' &< gbox 'GBOX M((-inf,-inf,-3.6e+09),(inf,inf,8.28e+10))';
SELECT gbox 'GBOX M((-inf,-inf,-3.6e+09),(inf,inf,8.28e+10))' >> gbox 'GBOX M((-inf,-inf,-3.6e+09),(inf,inf,8.28e+10))';
SELECT gbox 'GBOX M((-inf,-inf,-3.6e+09),(inf,inf,8.28e+10))' &> gbox 'GBOX M((-inf,-inf,-3.6e+09),(inf,inf,8.28e+10))';
...
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <</ gbox 'GBOX Z((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' &</ gbox 'GBOX Z((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' />> gbox 'GBOX Z((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' /&> gbox 'GBOX Z((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
...
SELECT gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <<# gbox 'GBOX M((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' &<# gbox 'GBOX M((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' #>> gbox 'GBOX M((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' #&> gbox 'GBOX M((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';

SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <<# gbox 'GBOX M((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' &<# gbox 'GBOX M((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' #>> gbox 'GBOX M((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' #&> gbox 'GBOX M((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
...
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <</ gbox 'GEODBOX((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' &</ gbox 'GEODBOX((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' />> gbox 'GEODBOX((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' /&> gbox 'GEODBOX((1.0, 2.0, 3.0), (1.0, 2.0, 3.0))';
...
SELECT gbox 'GBOX((1.0, 1.0), (2.0, 2.0))' << tgeompoint 'Point(1 1 1)@2000-01-01';
SELECT gbox 'GBOX((1.0, 1.0), (2.0, 2.0))' << tgeompoint '{Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03}';
SELECT gbox 'GBOX((1.0, 1.0), (2.0, 2.0))' << tgeompoint '[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03]';
SELECT gbox 'GBOX((1.0, 1.0), (2.0, 2.0))' << tgeompoint '{[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03],[Point(3 3 3)@2000-01-04, Point(3 3 3)@2000-01-05]}';

SELECT tgeompoint 'Point(1 1 1)@2000-01-01' << gbox 'GBOX((1.0, 1.0), (2.0, 2.0))';
SELECT tgeompoint '{Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03}' << gbox 'GBOX((1.0, 1.0), (2.0, 2.0))';
SELECT tgeompoint '[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03]' << gbox 'GBOX((1.0, 1.0), (2.0, 2.0))';
SELECT tgeompoint '{[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03],[Point(3 3 3)@2000-01-04, Point(3 3 3)@2000-01-05]}' << gbox 'GBOX((1.0, 1.0), (2.0, 2.0))';
...
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <</ tgeompoint 'Point(1 1 1)@2000-01-01';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <</ tgeompoint '{Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03}';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <</ tgeompoint '[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03]';
SELECT gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <</ tgeompoint '{[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03],[Point(3 3 3)@2000-01-04, Point(3 3 3)@2000-01-05]}';
...
SELECT tgeompoint 'Point(1 1 1)@2000-01-01' <</ gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))';
SELECT tgeompoint '{Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03}' <</ gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))';
SELECT tgeompoint '[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03]' <</ gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))';
SELECT tgeompoint '{[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03],[Point(3 3 3)@2000-01-04, Point(3 3 3)@2000-01-05]}' <</ gbox 'GBOX Z((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))';
...
SELECT gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <<# tgeompoint 'Point(1 1 1)@2000-01-01';
SELECT gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <<# tgeompoint '{Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03}';
SELECT gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <<# tgeompoint '[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03]';
SELECT gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))' <<# tgeompoint '{[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03],[Point(3 3 3)@2000-01-04, Point(3 3 3)@2000-01-05]}';
...
SELECT tgeompoint 'Point(1 1 1)@2000-01-01' <<# gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))';
SELECT tgeompoint '{Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03}' <<# gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))';
SELECT tgeompoint '[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03]' <<# gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))';
SELECT tgeompoint '{[Point(1 1 1)@2000-01-01, Point(2 2 2)@2000-01-02, Point(1 1 1)@2000-01-03],[Point(3 3 3)@2000-01-04, Point(3 3 3)@2000-01-05]}' <<# gbox 'GBOX M((1.0, 1.0, 1.0), (2.0, 2.0, 2.0))';
