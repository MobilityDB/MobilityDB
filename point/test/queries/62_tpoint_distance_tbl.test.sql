...
SELECT round(g <-> temp, 6) FROM tbl_geogpoint, tbl_tgeogpoint
WHERE g <-> temp IS NOT NULL LIMIT 10;
SELECT round(temp <-> g, 6) FROM tbl_tgeogpoint, tbl_geogpoint
WHERE temp <-> g IS NOT NULL LIMIT 10;
...
SELECT round(g <-> temp, 6) FROM tbl_geogpoint3D, tbl_tgeogpoint3D
WHERE g <-> temp IS NOT NULL LIMIT 10; 
SELECT round(temp <-> g, 6) FROM tbl_tgeogpoint3D, tbl_geogpoint3D
WHERE temp <-> g IS NOT NULL LIMIT 10;
