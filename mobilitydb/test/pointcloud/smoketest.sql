---------------------------------------------------------------------
-- Phase 8 end-to-end smoke test (self-contained, runnable via psql).
--
-- Requirements:
...
--
-- Exercises the full pgpointcloud stack Phase 8 landed:
--   pcpoint, pcpatch, pcpointset, pcpatchset, tpcbox,
--   tpcpoint, tpcpatch, and the projection + cast machinery.
---------------------------------------------------------------------

\echo '=== Phase 8 smoke: Base types (pcpoint/pcpatch accessors) ==='
...
\echo '=== Phase 8 smoke: Set types (pcpointset / pcpatchset dedup) ==='
...
\echo '=== Phase 8 smoke: TPCBox bounding box ==='
...
\echo '=== Phase 8 smoke: TPCBox set operations ==='
...
\echo '=== Phase 8 smoke: tpcpoint lifted temporal type ==='
...
\echo '=== Phase 8 smoke: tpcpatch lifted temporal type ==='
...
\echo '=== Phase 8 smoke: tpcpoint per-dimension projections ==='
...
\echo '=== Phase 8 smoke: tpcpoint → tgeompoint XY projection cast ==='
