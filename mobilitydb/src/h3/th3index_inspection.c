...
/*****************************************************************************
 * tbigint <-> th3index type-relabelling casts
 *
 * These wrappers update the temptype field so that the dispatcher
 * (tspatial_type, tspatial_set_stbox, …) sees the correct type tag.
 * The binary layout of tbigint and th3index is otherwise identical.
 *****************************************************************************/
...
/**
 * @ingroup mobilitydb_h3_inspection
 * @brief Cast a `tbigint` to `th3index`, rewriting the type tag
 * @sqlfn th3index()
 */
Datum
...
/**
 * @ingroup mobilitydb_h3_inspection
 * @brief Cast a `th3index` to `tbigint`, rewriting the type tag
 * @sqlfn tbigint()
 */
Datum
