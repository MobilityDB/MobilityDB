...
enlarge_list(List *list, int min_size)
{
  ...
  if (list->elements == list->initial_elements)
  {
     ...
     */
    wipe_mem(list->initial_elements, list->max_length * sizeof(ListCell));
  }
  else
  {
...
List *
list_make3_impl(NodeTag t, ListCell datum1, ListCell datum2, ListCell datum3)
{
...
List *
list_make4_impl(NodeTag t, ListCell datum1, ListCell datum2, ListCell datum3,
  ListCell datum4)
{
...
List *
list_make5_impl(NodeTag t, ListCell datum1, ListCell datum2, ListCell datum3,
