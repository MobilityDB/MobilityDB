...
/* MEOS vendoring: offset / minkowski / triangulation excluded — boolean
 * clipping subset only. Re-vendor those headers + their .cpp files if
 * you need offsetting, Minkowski sums, or triangulation. */
...
namespace Clipper2Lib {
  ...
  /* MEOS vendoring: InflatePaths overloads removed (depend on the
   * un-vendored clipper.offset.h). */
