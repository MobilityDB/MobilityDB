...
#
#   python scripts/inherited/generate.py            # emit new (non-reference) types
#   python scripts/inherited/generate.py --check     # dry-run, list target paths
#   python scripts/inherited/generate.py --validate   # self-regen reference == committed
...
BANNER = (
    "/* GENERATED by scripts/inherited/generate.py from "
