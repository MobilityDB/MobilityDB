...
# shape of check_btree_gist_operators.py. It reads mobilitydb/sql/**.sql to
# compare the members of an operator class with the operators the type
# declares; it extracts no API surface and generates nothing.
#
